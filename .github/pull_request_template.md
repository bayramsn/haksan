...
- [ ] `npm run db:lint:migrations` temiz geçti (yeni migration'larda high-severity bulgu yok)
- [ ] Migration **expand-contract** kurallarına uyuyor:
  ...
  - [ ] Index ekleme: büyük tablolarda `CREATE INDEX CONCURRENTLY`
  - [ ] Yeni UNIQUE constraint: mevcut veride duplicate olmadığı doğrulandı
