...
export class OpportunitiesService {
  ...
  async update(id: string, input: OpportunityUpdateInput, actor: AuthContext) {
    ...
    for (const k of ['companyId', 'primaryContactId', 'ownerUserId', 'title', 'description', 'probability', 'expectedCloseDate', 'paymentTermDays', 'paymentMethod', 'wonReason'] as const) {
