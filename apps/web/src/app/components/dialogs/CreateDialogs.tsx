            ...
            <div className="grid grid-cols-1 gap-4 lg:grid-cols-[minmax(0,1fr)_260px]">
              <div className="min-w-0 space-y-4">
                <div className="min-w-0">
                  <Label className="text-xs">Firma *</Label>
                  <select
                    className="mt-1.5 h-11 w-full rounded-md border border-input bg-input-background px-3 text-sm outline-none focus:border-ring focus:ring-2 focus:ring-ring/30"
                    value={form.customerId}
                ...
                <div className="min-w-0">
                  ...
                  >
                    <option value="">Makine bağlama</option>
                    ...
                    {otherCompanyMachines.length > 0 && (
                      <option value="__other_machines" disabled>──────── Diğer firmalar ────────</option>
                    )}
                    {otherCompanyMachines.map((machine) => (
                      <option key={machine.id} value={machine.id}>
                        {machineOptionText(machine, true)}
                      </option>
                    ))}
                  </select>
                </div>
